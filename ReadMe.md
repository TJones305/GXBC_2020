...
Bootstrap 4.4.1:
Bootstrap was used to assist with the responsiveness and styling of the website. Specific features include - navbar carousel, containers, carddecks/tiles.
Hover.css:
...
jQuery:
jQuery came with Bootstrap to make the navbar responsive but was also used for the carousel function in JavaScript.
popper.min.js:
popper.min.js was required for the carousel to function.
Git
...
*** Credits ***
Code
The GXBC_logo code came from Code Institute.
...
Content
All content was written by the developer. Acknowledgements for small sections of code at bottom of file.
...
banzomaikaka (solution comment on https://www.xspdf.com/help/50382383.html) for hover functionality code.     
...
Responsive Design for devices at approx. 600px width will need to be addressed in the future.
